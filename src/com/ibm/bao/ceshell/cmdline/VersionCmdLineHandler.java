/*
 * Modified version of VersionCmdLineHandler.java
 * for usage by CEShell
 *
 * Classes:
...
package com.ibm.bao.ceshell.cmdline;
 ...
 * "VersionCmdLineHandler.version.tag" in the <i>strings.properties</i> file
 * (set to "version", in English).
 * <P>
 ...
 * @version jcmdline Rel. @VERSION@ $Id: VersionCmdLineHandler.java,v 1.2
...
public class VersionCmdLineHandler extends AbstractHandlerDecorator {
	 ...
	 *             if <code>version</code> is null or empty.
	 */
	public VersionCmdLineHandler(String version, CmdLineHandler handler) {
		super(handler);
		if (version == null || version.length() == 0) {
			throw new IllegalArgumentException(Strings
					.get("VersionCmdLineHandler.versionEmptyError"));
		}
		this.version = version;
		versionOpt = new BooleanParam(Strings
				.get("VersionCmdLineHandler.version.tag"), Strings
				.get("VersionCmdLineHandler.version.desc"));
	 ...
	 */
	public VersionCmdLineHandler(String version, String cmdName,
	...
	public VersionCmdLineHandler(String version, String cmdName,
		...
		this(version, new DefaultCmdLineHandler(cmdName, cmdDesc, options,
				args, parser));
	}
	 ...
	 */
	protected ParseResultInfo processParsedOptions(ParseResultInfo parseOk) {
		if (parseOk.isSuccess()) {
